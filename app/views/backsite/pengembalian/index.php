                  ...
                  <tr>
                    <td><?= $no; ?></td>
                                       ...
                                       <td><?= $row['nama']; ?></td>
                                        ...
                                        <td><?= $row['status']; ?></td>
                    <td>
                    <a href="<?= BASEURL; ?>/backsite/pengembalian/edit/<?= $row['id'] ?>" class="badge badge-info"><i class="bi bi-pencil-square"></i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
    ...
    barisTabel.forEach(function (baris, indeks) {
      if (indeks % 2 === 0) {
        ...
        baris.style.backgroundColor = '#f9f9f9';
          ...
          <a href="<?= BASEURL; ?>/backsite/pengembalian/cetak" class="btn btn-primary mb-4"><i class="bi bi-printer-fill"></i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-printer-fill" viewBox="0 0 16 16">
