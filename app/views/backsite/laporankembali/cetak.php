...
<section class="content">
  <div class="container-fluid">
          ...
          <table style="width: 100%; text-align: center;">
            <tr>
              <td colspan="7">
                ...
                <h5>LAPORAN PENGEMBALIAN BUKU PERPUSTAKAAN</h5>
            ...
            <tr class="row-tempo">
              <td colspan="7">
                <div class="btn-group" role="group" aria-label="Basic example">
                  <a class="btn btn-secondary" href="/perpusweb/backsite/laporankembali">Kembali</a>
    ...
    <?php if (isset($_POST['startDate']) && isset($_POST['endDate'])) : ?>
      ...
      <p>Periode Pengembalian Buku: <?= date('d F Y', strtotime($_POST['startDate'])); ?> - <?= date('d F Y', strtotime($_POST['endDate'])); ?></p>
    <?php endif; ?>
