            ...
            function drawChart() {
                ...
                data.addRows([
                            ...
                            'f': `
                                <div class="row p-0 i_org">
                                    <div class="col-3 p-0 left">
                                        <img src="<?= BASEURL; ?>/assets/frontsite/img/logosmppgri.png" alt="">
                                    </div>
                                    <div class="col-9 p-0 text-uppercase right">
                                        <div class="box p-0">
                                            ...
                                            <div class="d-flex justify-content-center align-items-center flex-column bottom">
                                                <span>Kepala SMPS Pgri</span>
                                                <span>HERMAN SAPUTRA.SE</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    [{
                                ...
                                <div class="row p-0 i_org">
                                    ...
                                    <div class="col-9 p-0 text-uppercase right">
                                        <div class="box p-0">
                                            ...
                                            <div class="d-flex justify-content-center align-items-center flex-column bottom">
                                                <span>LINDA MARLINA DEWI S.PD</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        'penanggung_jawab', 'kesiswaan'
                    ],
                    [{
                            'v': 'kepalaperpustakaan',
                            'f': `
                                <div class="row p-0 i_org">
                                    <div class="col-3 p-0 left">
                                        <img src="<?= BASEURL; ?>/assets/frontsite/img/logosmppgri.png" alt="">
                    ...
                    [{
                            ...
                            'f': `
                                <div class="row p-0 i_org">
                                    ...
                                    <div class="col-9 p-0 text-uppercase right">
                                        <div class="box p-0">
                                            <div style="" class="d-flex justify-content-center align-items-center flex-column top">
                                                <span>Teknisi Pustaka</span>
                                            </div>
                                            <div class="d-flex justify-content-center align-items-center flex-column bottom">
                                                <span>MUHAMMAD HAKIM</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        'kepalaperpustakaan', 'teknisi pustaka'
                    ],
                    [{
                            'v': 'operator',
                            'f': `
                                <div class="row p-0 i_org">
                                    ...
                                    <div class="col-9 p-0 text-uppercase right">
                                        <div class="box p-0">
                                            <div style="" class="d-flex justify-content-center align-items-center flex-column top">
                                                <span>Operator Pustaka</span>
                                            </div>
                                            <div class="d-flex justify-content-center align-items-center flex-column bottom">
                                                <span>NITA NURASIH S.PD</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
